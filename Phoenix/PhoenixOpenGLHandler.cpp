...
void PhOpenGLHandler::DrawTexture2D(PhTexture* _pTexture, Vertex2& pos)
{
  ...
  glBegin(GL_QUADS);
  // Front Face
  glTexCoord2f(0.0f, 1.0f); glVertex3d(postopleft.x, postopleft.y,  0.5f);	// Bottom Left Of The Texture and Quad
  glTexCoord2f(1.0f, 1.0f); glVertex3d(postopleft.x + _pTexture->GetWidth(), postopleft.y,  0.5f);	// Bottom Right Of The Texture and Quad
  glTexCoord2f(1.0f, 0.0f); glVertex3d(postopleft.x + _pTexture->GetWidth(),  postopleft.y + _pTexture->GetHeight(),  0.5f);	// Top Right Of The Texture and Quad
  glTexCoord2f(0.0f, 0.0f); glVertex3d(postopleft.x,  postopleft.y + _pTexture->GetHeight(),  0.5f);	// Top Left Of The Texture and Quad
  glEnd();
